	...
	<div class="card card-outline card-success">
		<div class="card-header">
			<div class="card-tools">
				<a class="btn btn-block btn-sm btn-default btn-flat border-primary" href="./index.php?page=new_user"><i class="fa fa-plus"></i> Thêm Users mới</a>
			</div>
		</div>
		<div class="card-body">
...
<script>
	...
	_conf("Bạn có chắc chắn muốn xóa Users này không?","delete_user",[$(this).attr('data-id')])
	})
		$('#list').dataTable()
	})
