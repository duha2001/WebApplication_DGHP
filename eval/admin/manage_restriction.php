		...
		<div class="row">
			<div class="col-md-4 border-right">
				...
				<div class="form-group">
					<label for="" class="control-label">GV</label>
				...
				<div class="form-group">
					<div class="d-flex w-100 justify-content-center">
						<button class="btn btn-sm btn-flat btn-primary bg-gradient-primary" id="add_to_list" type="button">Thêm danh sách</button>
					</div>
				</div>
			</div>
			<div class="col-md-8">
			...
			$.ajax({
				...
				success:function(resp){
					if(resp == 1){
						...
						$('#msg').html('<div class="alert alert-danger"><i class="fa fa-exclamation-triangle"></i> Lớp đã được tồn tại.</div>')
						end_load()
					}
				}
			})
