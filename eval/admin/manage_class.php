...
<div class="container-fluid">
	<form action="" id="manage-class">
		...
		<div class="form-group">
			<label for="curriculum" class="control-label">Chương trình giáo dục</label>
