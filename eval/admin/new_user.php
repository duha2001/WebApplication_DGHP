				...
				<div class="row">
					<div class="col-md-6 border-right">
						<div class="form-group">
							...
							<input type="text" name="firstname" class="form-control form-control-sm" required value="<?php echo isset($firstname) ? $firstname : '' ?>"placeholder="VD: Trần Văn, Huỳnh Anh,...." required>
						</div>
						<div class="form-group">
							<label for="" class="control-label">Tên</label>
							<input type="text" name="lastname" class="form-control form-control-sm" required value="<?php echo isset($lastname) ? $lastname : '' ?>"placeholder="VD: A, Dự, Tèo, Tí, ...." required>
						</div>
						<div class="form-group">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							...
							<input type="email" class="form-control form-control-sm" name="email" required value="<?php echo isset($email) ? $email : '' ?>"placeholder="VD: tranvana2001@gmail.com, ...." required>
							<small id="#msg"></small>
						</div>
						<div class="form-group">
