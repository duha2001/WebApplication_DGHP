	...
	<div class="card card-outline card-primary">
		<div class="card-header">
			<div class="card-tools">
				<a class="btn btn-block btn-sm btn-default btn-flat border-primary new_class" href="javascript:void(0)"><i class="fa fa-plus"></i>Thêm mới</a>
			</div>
		</div>
		<div class="card-body">
...
<script>
	$(document).ready(function(){
		...
		$('.new_class').click(function(){
			uni_modal("Thêm lớp","<?php echo $_SESSION['login_view_folder'] ?>manage_class.php")
		})
		$('.manage_class').click(function(){
			uni_modal("Chỉnh sửa lớp","<?php echo $_SESSION['login_view_folder'] ?>manage_class.php?id="+$(this).attr('data-id'))
		})
	$('.delete_class').click(function(){
	_conf("Bạn có chắc chắn muốn xóa lớp ?","delete_class",[$(this).attr('data-id')])
	})
	})
