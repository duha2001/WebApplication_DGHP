...
<div class="col-lg-12">
	...
	<div class="row">
		...
		<div class="col-md-9">
			...
			<div>
			<h3 class="text-center">Báo cáo đánh giá</h3>
			<hr>
			<table width="100%">
					<tr>
					...
					<tr>
						<td width="50%"><p><b>Lớp: <span id="classField"></span></b></p></td>
						<td width="50%"><p><b>Môn học: <span id="subjectField"></span></b></p></td>
					</tr>
			</table>
				<p class=""><b>Tổng số sinh viên đánh giá: <span id="tse"></span></b></p>
			</div>
