		...
		<div class="col-md-9">
			<div class="card card-outline card-info">
				<div class="card-header">
					<b>Bảng câu hỏi đánh giá cho năm học: <?php echo $_SESSION['academic']['year'].'- Học kì '.(ordinal_suffix($_SESSION['academic']['semester'])) ?> </b>
					<div class="card-tools">
						<button class="btn btn-sm btn-flat btn-primary bg-gradient-primary mx-1" form="manage-evaluation">Hoàn tất đánh giá</button>
					</div>
				</div>
				<div class="card-body">
